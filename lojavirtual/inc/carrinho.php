...
<div class="carrinho">
    ...
    <?
		...
		foreach($_SESSION['carrinho'] as $produto){
			$valor = ($produto['pro_valor'] - $produto['pro_desconto']) * $produto['qtd'];
			$total += $valor;
	?>
    <div class="item_carrinho">
        <div class="foto">
        	<img src="img/produto/<?=$produto['img_caminho']?>" />
        </div>
        <div class="descricao"><?=$produto['pro_descricao']?></div>
        <div class="qtd">
        ...
        <div class="v_unitario">
        	R$ <?=moeda($produto['pro_valor'] - $produto['pro_desconto'])?>
        </div>
